...
import { CharHook, DataManager, EventManager } from "cdda-event";
...
/**手持触发 */
function genWieldTrigger(dm:DataManager,flagId:FlagID,hook:CharHook,effects:EocEffect[],condition?:BoolObj){
